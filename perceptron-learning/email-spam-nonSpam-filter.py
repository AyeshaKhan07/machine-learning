...
epochs = 5000  # Number of iterations over the dataset
...
print("Prediction for Test Email 1:", "Spam" if predict(test_email_1) == 1 else "Non-Spam")
print("Prediction for Test Email 2:", "Spam" if predict(test_email_2) == 1 else "Non-Spam")
